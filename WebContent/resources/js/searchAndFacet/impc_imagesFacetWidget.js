...
//	    			: self.options.data.hashParams.fq;
	    	...
	    	var oParams = {};		
	        oParams = $.fn.getSolrRelevanceParams('impc_images', self.options.data.hashParams.q, oParams);
	    	...
	    	var queryParams = $.extend({}, {				
				...
				'facet.limit': -1,
				'facet.sort': 'index',	
				'fl': 'procedure_name,gene_symbol,gene_accession_id'
  	    	...
  	    	$.ajax({	
  	    		'url': solrUrl + '/impc_images/select',  	    		
  	    		'data': paramStr,  				
  	    		'dataType': 'jsonp',
  	    		'jsonp': 'json.wrf',	    		
  	    		'success': function(json) {
  	    			...
  	    			for ( var n=0; n<aSubFacetNames.length; n++){
  	    				...
  	    				for ( var i=0; i<aFacetFields[facetName].length; i+=2){    					  					
  		    	    		...
  		    	    		var coreField = 'impc_images|'+ 'impcImg_' + facetName + '|' + fieldName + '|' + count + '|' + label;	
