...
<c:forEach var="timeChart" items="${timeSeriesCharts}" varStatus="timeLoop">
 <%-- ${loop.count  % 2} --%>
	<c:if test = "${timeLoop.count  % 2!=0}">
		<div class="row-fluid dataset">  
		 <div class="row-fluid "><div class="container span12"><h4><!--  style="background-color:lightgrey;"  -->Allele -  ${timeSeriesMutantBiologicalModels[timeLoop.index].alleles[0].symbol} <span class="graphGenBackground">background -  ${timeSeriesMutantBiologicalModels[timeLoop.index].geneticBackground}</span></h4></div>
 		</div>
 		<div class="row-fluid">
 	</c:if>
  				 <div class="container span6">
...
<c:if test = "${loop.count  % 2!=0}">
		<div class="row-fluid dataset">  
		 <div class="row-fluid"><div class="container span12"><h4>Allele -  ${categoricalMutantBModel[loop.index].alleles[0].symbol} <span class="graphGenBackground">background -  ${categoricalMutantBModel[loop.index].geneticBackground}</span></h4></div>
 		</div>
 		<div class="row-fluid">
 </c:if>
  				 <div class="container span6">
...
<c:if test = "${uniDimensionalLoop.count  % 2!=0}">
		<div class="row-fluid dataset">  
		 <div class="row-fluid"><div class="container span12"><h4>Allele -  ${unidimensionalMutantBiologicalModels[uniDimensionalLoop.index].alleles[0].symbol} <span class="graphGenBackground">background -  ${unidimensionalMutantBiologicalModels[uniDimensionalLoop.index].geneticBackground}</span></h4></div>
 		</div>
 		<div class="row-fluid">
 </c:if>
