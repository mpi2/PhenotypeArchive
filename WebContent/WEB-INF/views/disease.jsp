...
//                        $(this).next().html("<td></td>").prepend("<i></i>").addClass("fa fa-spinner fa-spin");
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#potential_phenotypes tr:odd").addClass("odd");
                $("#potential_phenotypes tr:not(.odd)").hide();
                $("#potential_phenotypes tr:first-child").show();

                $("#potential_phenotypes tr.odd").click(function () {
                    $(this).next("tr").toggle();
                    if ($(this).next("tr").find("td").length === 0) {
                        getDiseaseAssociations($(this));
                    }
            ...
            <div class="inner">                
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <table id="orthologous_phenotypes" class="table tableSorter"> 
                            <thead>
                                <tr>
        ...
        <div class="section">
            ...
            <div class="inner">                
                <c:choose>
                    ...
                    <c:otherwise>
                        <!--The following genes are associated with ${disease.diseaseId} by phenotypic similarity.-->
                        <table id="potential_phenotypes" class="table tableSorter"> 
                            <thead>
                                <tr>
                                    <!--<th>Human Gene Symbol</th>-->
                                    <th><span class="main">Mouse Gene Symbol</span></th>
