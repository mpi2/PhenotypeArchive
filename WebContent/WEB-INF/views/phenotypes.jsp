		...
		<div id='mpMain'>
			...
			<div class="row-fluid dataset">
				<div class="container span12">
					...
					<div id="ovRight" class="span4"><c:if test="${not empty images}"><img src="${baseUrl}/media/images/${images[0].largeThumbnailFilePath}"/></c:if></div>
					<div id="ovRightPaddingRight" class="span2"></div>
				</div>
			</div>      		
		</div>	
	
		<script type='text/javascript' src='${baseUrl}/js/utils/highlight.js'></script>
							...
							<div id="pheno" class="accordion-body collapse in">
								<div class="accordion-inner">
			    					...
			    					<c:forEach var="doc" items="${images}">
										<li class="span2"><a href="${baseUrl}/media/images/${doc.fullResolutionFilePath}"><img src="${baseUrl}/media/images/${doc.smallThumbnailFilePath}" /></a>
