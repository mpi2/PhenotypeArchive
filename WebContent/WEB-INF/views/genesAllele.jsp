                        ...
                        <c:choose>
                                ...
                                <c:otherwise>
                                        ...
                                        <td>
                                            ...
                                            <a title="project page" href="http://www.mousephenotype.org/martsearch_ikmc_project/martsearch/ikmc_project/${alleleProduct['ikmcProjectId']}"><i class="fa fa-clipboard fa-lg"></i></a>
                                        
<!--                                            <a title="allele page" href="/phenotype-archive/alleles/${alleleProduct['mgi_accession_id']}"><i class="fa fa-clipboard fa-lg"></i></a>-->
                                        
                                            <a title="allele project page" href="/phenotype-archive/alleles/${alleleProduct['mgi_accession_id']}/${alleleProduct['mgiAlleleNameStrip']}"><i class="fa fa-clipboard fa-lg"></i></a>
                                        </td>
