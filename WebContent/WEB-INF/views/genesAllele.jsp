                ...
                <c:forEach var="alleleProduct" items="${alleleProducts}" varStatus="status">
                        ...
                        <c:choose>
                                ...
                                <c:otherwise>
                                        ...
                                        <td style="padding-left:10px"><div><a href="${alleleProduct["alleleMap"]}" target="_blank"><img width="400" src="${alleleProduct["alleleMap"]}?simple=true" alt="allele image"></a></div></td>
