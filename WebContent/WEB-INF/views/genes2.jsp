		...
		<div class="row-fluid">
			...
			<div class="container span8">
				...
				<table>				  
					<tbody>
					<tr>
					<th>Short Name</th><th>Allele</th><th>Genetic Background</th><th>Production Status</th><th>Phenotyping Status</th><th>Order</th></tr>
	<c:forEach var="construct" items="${constructs}" varStatus="constructLoop">	
			<tr><td>${construct.shortName}</td><td>${construct.alleleName}</td><td>${construct.strain}</td><td>Prod Status</td><td>Phen Status</td><td><a href="#myModal${ constructLoop.index}" role="button" class="btn" data-toggle="modal">Available</a> </td>
				</tr>
