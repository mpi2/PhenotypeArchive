                ...
                <div class="region region-content">              
                    ...
                    <div class="block block-system">
                        ...
                        <div id="top" class="content node">
                            ...
                            <p>After clicking on the control legend the male homozygote data has disappeared:<img src="img/graph_no_control.png" alt="chart with no control here">
                            </p>
                            <p>Hovering over a data point or error bars displays extra information about the data point:<img src="img/graph_hover.png" alt="chart with a hovering over mouse label here">
                            </p>
                            <p>If appropriate the chart will allow you to zoom in on a data set by clicking and dragging to create a square/zoomable area:<img src="img/graph_before_zoom.png" alt="Scatter chart with no zoom shown here">
                            </p>
                            <p>Once zoomed a "Reset zoom" button appears at the right of the chart to enable the chart to be reset to original position:
                            ...
                            <p>
                                Currently 4 types of chart exist in the IMPC portal from the IMPC: 
                            </p>
                            <ol>
