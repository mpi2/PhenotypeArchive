			...
			<div class="inner">
				...
				<c:when test="${phenotypeSummaryObjects.getBothPhenotypes().size() > 0 or phenotypeSummaryObjects.getFemalePhenotypes().size() > 0 or phenotypeSummaryObjects.getMalePhenotypes().size() > 0 }">
					<div class="abnormalities">
						...
						<div class="no-sprite sprite_growth_size_phenotype" data-hasqtip="27" title="growth size phenotype"></div>
						...
						<div class="no-sprite sprite_hearing_vestibular_ear_phenotype " data-hasqtip="27" title="shearingvestibular ear phenotype"></div>
