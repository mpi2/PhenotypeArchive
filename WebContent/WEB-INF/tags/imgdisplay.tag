...
<%@ attribute name="mediaBaseUrl" required="true" %>
         ...
         <a href="${mediaBaseUrl}/${img.largeThumbnailFilePath}"><img src="${mediaBaseUrl}/${img.smallThumbnailFilePath}"></a><div class="data-title"><a href="#"><i class="fa fa-download"></i> Download this image in high resolution</a></div>
                                                <div class="caption">
