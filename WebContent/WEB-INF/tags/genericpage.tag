	...
	<div class="container" style="padding-top:0;">
		...
		<div id="examples" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<div>
					<h4>Phrase query Example</h4>
					<p><a class="example" href="${baseUrl}/search#q=\"zinc finger protein\"&core=gene">"zinc finger protein"</a> - looking for genes whose product is zinc finger protein</p>
				</div>
