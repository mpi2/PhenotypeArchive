...
public class SearchPage {
    ...
    public SearchPage(WebDriver driver, long timeoutInSeconds, PhenotypePipelineDAO phenotypePipelineDAO) {
        this.driver = driver;
    ...
    public int getGenesFacetCount() {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[@id='gene']/span[@class='fcount' or @class='fcount grayout']")));
        Integer niCount = Utils.tryParseInt(element.getText());
        
        return (niCount == null ? 0 : niCount);
    }
    
    public int getPhenotypesFacetCount() {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[@id='mp']/span[@class='fcount' or @class='fcount grayout']")));
        Integer niCount = Utils.tryParseInt(element.getText());
        
        return (niCount == null ? 0 : niCount);
    }
    
    public int getDiseasesFacetCount() {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[@id='disease']/span[@class='fcount' or @class='fcount grayout']")));
        Integer niCount = Utils.tryParseInt(element.getText());
        
        return (niCount == null ? 0 : niCount);
    }
    
    public int getAnatomyFacetCount() {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[@id='ma']/span[@class='fcount' or @class='fcount grayout']")));
        Integer niCount = Utils.tryParseInt(element.getText());
        
        return (niCount == null ? 0 : niCount);
    }
    
    public int getProceduresFacetCount() {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[@id='pipeline']/span[@class='fcount' or @class='fcount grayout']")));
        Integer niCount = Utils.tryParseInt(element.getText());
        
        return (niCount == null ? 0 : niCount);
    }
    
    public int getImagesFacetCount() {
        WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[@id='images']/span[@class='fcount' or @class='fcount grayout']")));
        Integer niCount = Utils.tryParseInt(element.getText());
...
//////            }
//////            SearchPage graphByDatePage = null;
...
//////                graphByDatePage = new SearchPage(driver, timeoutInSeconds, phenotypePipelineDAO);
