 ...
 * page.
 */
public class DownloadStructureCategorical implements DownloadStructure {
...
//    
//    public DownloadStructureUnidimensional(WebDriver driver, WebDriverWait wait, String target) {
//        this.driver = driver;
//        this.wait = wait;
//        this.target = target;
//    }
