...
public class PhenotypeTablePheno extends PhenotypeTable {
    ...
    /**
     * @return The 0-relative phenotype column index in the pheno page's phenotypes html table.
     */
    public int getColIndexGeneAllele() { return 0; }
    
    /**
     * @return The 0-relative zygosity column index in the pheno page's phenotypes html table.
     */
    @Override
    public int getColIndexZygosity(){ return 1; }
    
    /**
     * @return The 0-relative sex column index in the pheno page's phenotypes html table.
     */
    @Override
    ...
    /**
     * @return The 0-relative procedure | parameter column index in the pheno page's phenotypes html table.
     */
    @Override
    public int getColIndexProcedureParameter(){ return 4; }
    
    /**
     * @return The 0-relative phenotyping center column index in the pheno page's phenotypes html table.
     */
    @Override
    public int getColIndexPhenotypingCenter(){ return 5; }
    
    /**
     * @return The 0-relative source column index in the pheno page's phenotypes html table.
     */
    @Override
    public int getColIndexSource(){ return 6; }
    
    /**
     * @return The 0-relative p value column index in the pheno page's phenotypes html table.
     */
    @Override
    public int getColIndexPvalue(){ return 7; }
    
    /**
     * @return The 0-relative graph link column index in the pheno page's phenotypes html table.
     */
    @Override
    public int getColIndexGraph(){ return 8; }
    
    /**
     * @return The number of columns in the pheno page's phenotypes html table.
     */
    @Override
    public int getTableColumnCount() { return 9; }

    /**
     * Pulls <code>maxRows</code> rows of data from the pheno page's 'phenotypes'
        ...
        for (int rowIndex = 0; rowIndex < maxRows; rowIndex++) {
            ...
            for (int colIndex = 0; colIndex < getTableColumnCount(); colIndex++) {
                ...
                if (rowIndex == 0) {
                    ...
                    } else if (colIndex == getColIndexGeneAllele()) {
                        String value = "";
                        String xxxvalue = tdElement.findElement(By.xpath("a")).getText();
                        try { value = URLDecoder.decode(xxxvalue, "UTF-8"); } catch (UnsupportedEncodingException e) { }
