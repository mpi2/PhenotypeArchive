 ...
 * @author mrelac
 *
 * This class contains column index definitions for the categorical graph page
 * catTable HTML table. The class implements the contract defined by the
 * DownloadGraphMap interface as well as any additional methods pertaining to a
 * download stream from a graph page.
 */
public class DownloadGraphMapCategorical implements DownloadGraphMap {
