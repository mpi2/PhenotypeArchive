...
public class GenotypePhenotypeIndexer extends AbstractIndexer {
	...
	public void populateImpressDataMap() throws SQLException {
		...
		queries.add("SELECT id, stable_key, name, stable_id, 'PIPELINE' as impress_type FROM phenotype_pipeline");
		queries.add("SELECT id, stable_key, name, stable_id, 'PROCEDURE' as impress_type FROM phenotype_procedure");
		queries.add("SELECT id, stable_key, name, stable_id, 'PARAMETER' as impress_type FROM phenotype_parameter");
